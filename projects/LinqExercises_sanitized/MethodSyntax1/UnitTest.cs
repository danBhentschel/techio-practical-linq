...
namespace MethodSyntax1
{
    ...
    public class UnitTest
    {
        ...
        public void Exercise1()
        {
            ...
            answer = MethodSyntax1.FilterAndSort(new List<string> { "abc", "bca", "cba", "aaa" }, "a");
            ...
            answer = MethodSyntax1.FilterAndSort(new List<string> { "pointer", "reference", "structure", "integer" }, "er");
